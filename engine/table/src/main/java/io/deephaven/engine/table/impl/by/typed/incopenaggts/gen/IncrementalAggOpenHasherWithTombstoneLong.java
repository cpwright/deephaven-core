...
final class IncrementalAggOpenHasherWithTombstoneLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    private ImmutableLongArraySource mainKeySource0;

    private ImmutableLongArraySource alternateKeySource0;

    public IncrementalAggOpenHasherWithTombstoneLong(ColumnSource[] tableKeySources,

...
final class IncrementalAggOpenHasherFloatInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherFloatInt(ColumnSource[] tableKeySources,

...
// ****** Edit ByteSegmentedSortedArray and run "./gradlew replicateSegmentedSortedArray" to regenerate
//
// @formatter:off
...
public final class ByteReverseSegmentedSortedArray implements SegmentedSortedArray {
    ...
    public <T extends Any> int insertAndGetNextValue(Chunk<T> valuesToInsert,
        ...
        final ByteChunk<T> insertChunk = valuesToInsert.asByteChunk();
        if (leafCount == 0
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots,
        ...
        final byte[] sourceValues = leafValues[startingLeaf];
        ...
        for (int workingSlot = startingLeaf + distributionSlots - 1; workingSlot >= startingLeaf; workingSlot--) {
            ...
            final byte[] slotValues = leafValues[workingSlot];
            ...
            for (int wpos = leafSize - 1; wpos >= 0; wpos--) {
                ...
                final byte vall = sourceValues[rposl];

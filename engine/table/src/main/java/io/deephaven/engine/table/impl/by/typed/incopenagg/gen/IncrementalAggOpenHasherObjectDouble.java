...
final class IncrementalAggOpenHasherObjectDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherObjectDouble(ColumnSource[] tableKeySources,

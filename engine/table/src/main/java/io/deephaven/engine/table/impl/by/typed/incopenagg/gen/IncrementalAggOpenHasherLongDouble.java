...
final class IncrementalAggOpenHasherLongDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherLongDouble(ColumnSource[] tableKeySources,

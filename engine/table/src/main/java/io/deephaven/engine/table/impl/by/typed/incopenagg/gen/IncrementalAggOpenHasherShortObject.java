...
final class IncrementalAggOpenHasherShortObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherShortObject(ColumnSource[] tableKeySources,

...
final class IncrementalAggOpenHasherByteDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherByteDouble(ColumnSource[] tableKeySources,

...
final class IncrementalAggOpenHasherByteChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherByteChar(ColumnSource[] tableKeySources,

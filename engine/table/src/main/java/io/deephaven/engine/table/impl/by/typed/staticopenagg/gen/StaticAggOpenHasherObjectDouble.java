...
final class StaticAggOpenHasherObjectDouble extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableObjectArraySource mainKeySource0;

    private final ImmutableDoubleArraySource mainKeySource1;

    public StaticAggOpenHasherObjectDouble(ColumnSource[] tableKeySources,

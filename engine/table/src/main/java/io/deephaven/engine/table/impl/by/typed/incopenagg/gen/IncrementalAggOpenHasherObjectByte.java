...
final class IncrementalAggOpenHasherObjectByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherObjectByte(ColumnSource[] tableKeySources,

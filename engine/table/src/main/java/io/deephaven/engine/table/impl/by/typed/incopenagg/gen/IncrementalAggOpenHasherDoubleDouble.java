...
final class IncrementalAggOpenHasherDoubleDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherDoubleDouble(ColumnSource[] tableKeySources,

...
final class StaticAggOpenHasherFloatShort extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableFloatArraySource mainKeySource0;

    private final ImmutableShortArraySource mainKeySource1;

    public StaticAggOpenHasherFloatShort(ColumnSource[] tableKeySources,

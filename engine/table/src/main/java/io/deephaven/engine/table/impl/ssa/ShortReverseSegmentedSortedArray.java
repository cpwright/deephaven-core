...
public final class ShortReverseSegmentedSortedArray implements SegmentedSortedArray {
    ...
    public <T extends Any> int insertAndGetNextValue(Chunk<T> valuesToInsert,
        ...
        final short[] nextArray = new short[insertSize];
        ...
        nextValue.asWritableShortChunk().copyFromTypedArray(nextArray, 0, 0, found);
        return found;
    }
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots,
            ...
            @Nullable short[] nextValues, int nextOffset) {

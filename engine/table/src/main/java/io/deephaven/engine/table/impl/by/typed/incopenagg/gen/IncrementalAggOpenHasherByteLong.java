...
final class IncrementalAggOpenHasherByteLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherByteLong(ColumnSource[] tableKeySources,

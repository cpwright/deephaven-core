 ...
 */
public class ByteRollupDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    private UpdateCommitter<ByteRollupDistinctOperator> prevFlusher = null;
    private WritableRowSet touchedStates;

    public ByteRollupDistinctOperator(
            // region Constructor
    ...
    public void startTrackingPrevValues() {
        ...
        prevFlusher = new UpdateCommitter<>(this, ExecutionContext.getContext().getUpdateGraph(),
                ByteRollupDistinctOperator::flushPrevious);
        touchedStates = RowSetFactory.empty();
        internalResult.startTrackingPrevValues();
    }

    private static void flushPrevious(ByteRollupDistinctOperator op) {

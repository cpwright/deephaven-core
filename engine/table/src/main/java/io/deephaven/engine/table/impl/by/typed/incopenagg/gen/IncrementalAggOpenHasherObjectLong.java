...
final class IncrementalAggOpenHasherObjectLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherObjectLong(ColumnSource[] tableKeySources,

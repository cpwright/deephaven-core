...
final class IncrementalAggOpenHasherWithTombstoneFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    private ImmutableFloatArraySource mainKeySource0;

    private ImmutableFloatArraySource alternateKeySource0;

    public IncrementalAggOpenHasherWithTombstoneFloat(ColumnSource[] tableKeySources,

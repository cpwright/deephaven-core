...
final class RightIncrementalAsOfJoinHasherDouble extends RightIncrementalAsOfJoinStateManagerTypedBase {
    private ImmutableDoubleArraySource mainKeySource0;

    private ImmutableDoubleArraySource alternateKeySource0;

    public RightIncrementalAsOfJoinHasherDouble(ColumnSource[] tableKeySources,

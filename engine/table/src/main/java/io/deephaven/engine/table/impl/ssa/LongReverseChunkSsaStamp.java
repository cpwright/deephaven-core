...
// ****** Edit LongChunkSsaStamp and run "./gradlew replicateReverseSegmentedSortedArray" to regenerate
//
// @formatter:off
...
public class LongReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    public void processEntry(Chunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, SegmentedSortedArray ssa,
        ...
        processEntry(leftStampValues.asLongChunk(), leftStampKeys, (LongReverseSegmentedSortedArray) ssa, rightKeysForLeft,
                disallowExactMatch);
    }

    private static void processEntry(LongChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys,
            LongReverseSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
    ...
    public void processRemovals(Chunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
        ...
        processRemovals(leftStampValues.asLongChunk(), leftStampKeys, rightStampChunk.asLongChunk(), rightKeys,
                priorRedirections, rowRedirection, modifiedBuilder, disallowExactMatch);
    }

    private static void processRemovals(LongChunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
            LongChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys,
    ...
    public int findModified(int first, Chunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
        ...
        return findModified(first, leftStampValues.asLongChunk(), leftStampKeys, rowRedirection,
                rightStampChunk.asLongChunk(), rightStampIndices, modifiedBuilder, disallowExactMatch);
    }
    ...
    public void applyShift(Chunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
        ...
        applyShift(leftStampValues.asLongChunk(), leftStampKeys, rightStampChunk.asLongChunk(), rightStampKeys,
                shiftDelta, rowRedirection, disallowExactMatch);
    }

    private void applyShift(LongChunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
            LongChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampKeys, long shiftDelta,
            WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        int leftLowIdx = 0;
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final long rightStampValue = rightStampChunk.get(ii);
    ...
    private static int findFirstResponsiveLeft(int leftLowIdx, LongChunk<Values> leftStampValues,
            boolean disallowExactMatch, long rightStampValue) {

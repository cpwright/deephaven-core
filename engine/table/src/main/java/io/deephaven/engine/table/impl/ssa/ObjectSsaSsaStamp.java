...
public class ObjectSsaSsaStamp implements SsaSsaStamp {
    ...
    public void processEntry(SegmentedSortedArray leftSsa, SegmentedSortedArray rightSsa,
        ...
        processEntry((ObjectSegmentedSortedArray) leftSsa, (ObjectSegmentedSortedArray) rightSsa, rowRedirection,
                disallowExactMatch);
    }

    private static void processEntry(ObjectSegmentedSortedArray leftSsa, ObjectSegmentedSortedArray rightSsa,
            WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithNull(WritableRowRedirection rowRedirection, ObjectSegmentedSortedArray.Iterator leftIt) {
        while (leftIt.hasNext()) {
            leftIt.next();
            rowRedirection.removeVoid(leftIt.getKey());
        }
    ...
    private static void fillWithValue(WritableRowRedirection rowRedirection, ObjectSegmentedSortedArray.Iterator leftIt,
            long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    public void processRemovals(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        processRemovals((ObjectSegmentedSortedArray) leftSsa, rightStampChunk.asObjectChunk(), rightKeys, priorRedirections,
                rowRedirection, modifiedBuilder, disallowExactMatch);
    }

    static private void processRemovals(ObjectSegmentedSortedArray leftSsa, ObjectChunk<Object, ? extends Values> rightStampChunk,
    ...
    public void findModified(SegmentedSortedArray leftSsa, RowRedirection rowRedirection,
        ...
        findModified((ObjectSegmentedSortedArray) leftSsa, rowRedirection, rightStampChunk.asObjectChunk(),
                rightStampIndices, modifiedBuilder, disallowExactMatch);
    }

    private static void findModified(ObjectSegmentedSortedArray leftSsa, RowRedirection rowRedirection,
    ...
    public void applyShift(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        applyShift((ObjectSegmentedSortedArray) leftSsa, rightStampChunk.asObjectChunk(), rightStampKeys, shiftDelta,
                rowRedirection, disallowExactMatch);
    }

    private void applyShift(ObjectSegmentedSortedArray leftSsa, ObjectChunk<Object, ? extends Values> rightStampChunk,
            LongChunk<RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection,
            boolean disallowExactMatch) {
        final ObjectSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);

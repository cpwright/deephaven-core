...
public class ObjectLongTimsortKernel {
    ...
    public static class ObjectLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ObjectLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(
            ...
            ObjectLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }

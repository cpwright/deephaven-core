...
// ****** Edit NullAwareCharLongTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
public class NullAwareCharLongTimsortDescendingKernel {
    ...
    public static class CharLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            NullAwareCharLongTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(
            ...
            NullAwareCharLongTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }

...
final class IncrementalAggOpenHasherByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private ImmutableByteArraySource mainKeySource0;

    private ImmutableByteArraySource alternateKeySource0;

    public IncrementalAggOpenHasherByte(ColumnSource[] tableKeySources,

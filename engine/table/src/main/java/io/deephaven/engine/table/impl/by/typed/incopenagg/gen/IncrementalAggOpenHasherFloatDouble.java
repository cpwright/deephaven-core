...
final class IncrementalAggOpenHasherFloatDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherFloatDouble(ColumnSource[] tableKeySources,

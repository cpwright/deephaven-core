...
final class IncrementalAggOpenHasherWithTombstoneObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    private ImmutableObjectArraySource mainKeySource0;

    private ImmutableObjectArraySource alternateKeySource0;

    public IncrementalAggOpenHasherWithTombstoneObject(ColumnSource[] tableKeySources,

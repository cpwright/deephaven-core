...
final class IncrementalAggOpenHasherWithTombstoneChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    private ImmutableCharArraySource mainKeySource0;

    private ImmutableCharArraySource alternateKeySource0;

    public IncrementalAggOpenHasherWithTombstoneChar(ColumnSource[] tableKeySources,

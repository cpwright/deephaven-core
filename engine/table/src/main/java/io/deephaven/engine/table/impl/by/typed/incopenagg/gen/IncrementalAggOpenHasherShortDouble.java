...
final class IncrementalAggOpenHasherShortDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherShortDouble(ColumnSource[] tableKeySources,

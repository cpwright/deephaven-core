...
class ObjectChunkedAddOnlyMinMaxOperator implements IterativeChunkedAggregationOperator {
    ...
    private static Object min(ObjectChunk<Object, ?> values, MutableInt chunkNonNull, int chunkStart, int chunkEnd) {
        int nonNull = 0;
        Object value = null;
    ...
    private static Object max(ObjectChunk<Object, ?> values, MutableInt chunkNonNull, int chunkStart, int chunkEnd) {
        int nonNull = 0;
        Object value = null;
        for (int ii = chunkStart; ii < chunkEnd; ++ii) {
            final Object candidate = values.get(ii);

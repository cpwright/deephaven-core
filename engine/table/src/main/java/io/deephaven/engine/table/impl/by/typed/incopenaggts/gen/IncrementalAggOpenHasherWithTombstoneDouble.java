...
final class IncrementalAggOpenHasherWithTombstoneDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    private ImmutableDoubleArraySource mainKeySource0;

    private ImmutableDoubleArraySource alternateKeySource0;

    public IncrementalAggOpenHasherWithTombstoneDouble(ColumnSource[] tableKeySources,

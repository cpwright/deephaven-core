...
final class StaticAggOpenHasherFloatChar extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableFloatArraySource mainKeySource0;

    private final ImmutableCharArraySource mainKeySource1;

    public StaticAggOpenHasherFloatChar(ColumnSource[] tableKeySources,

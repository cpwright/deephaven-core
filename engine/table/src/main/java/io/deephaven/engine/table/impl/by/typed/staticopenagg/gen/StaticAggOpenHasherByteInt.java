...
final class StaticAggOpenHasherByteInt extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableByteArraySource mainKeySource0;

    private final ImmutableIntArraySource mainKeySource1;

    public StaticAggOpenHasherByteInt(ColumnSource[] tableKeySources,

...
// ****** Edit CharSegmentedSortedArray and run "./gradlew replicateDupCompactKernel" to regenerate
//
// @formatter:off
...
public final class NullAwareCharSegmentedSortedArray implements SegmentedSortedArray {
    ...
    public <T extends Any> int insertAndGetNextValue(Chunk<T> valuesToInsert,
        ...
        final char[] nextArray = new char[insertSize];
        ...
        nextValue.asWritableCharChunk().copyFromTypedArray(nextArray, 0, 0, found);
        return found;
    }
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots,
            ...
            @Nullable char[] nextValues, int nextOffset) {

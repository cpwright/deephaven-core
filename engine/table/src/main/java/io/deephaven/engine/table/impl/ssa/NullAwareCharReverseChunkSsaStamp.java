...
// ****** Edit NullAwareCharReverseChunkSsaStamp and run "./gradlew replicateSegmentedSortedArray" to regenerate
//
// @formatter:off
...
public class NullAwareCharReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    public void processEntry(Chunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, SegmentedSortedArray ssa,
        ...
        processEntry(leftStampValues.asCharChunk(), leftStampKeys, (NullAwareCharReverseSegmentedSortedArray) ssa, rightKeysForLeft,
                disallowExactMatch);
    }

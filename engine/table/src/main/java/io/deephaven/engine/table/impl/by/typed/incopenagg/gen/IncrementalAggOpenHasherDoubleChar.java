...
final class IncrementalAggOpenHasherDoubleChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherDoubleChar(ColumnSource[] tableKeySources,

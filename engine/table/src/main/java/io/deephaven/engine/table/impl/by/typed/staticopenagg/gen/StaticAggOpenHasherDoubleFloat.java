...
final class StaticAggOpenHasherDoubleFloat extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableDoubleArraySource mainKeySource0;

    private final ImmutableFloatArraySource mainKeySource1;

    public StaticAggOpenHasherDoubleFloat(ColumnSource[] tableKeySources,

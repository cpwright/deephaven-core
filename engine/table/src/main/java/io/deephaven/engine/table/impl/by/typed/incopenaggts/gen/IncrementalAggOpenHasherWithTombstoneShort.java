...
final class IncrementalAggOpenHasherWithTombstoneShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    private ImmutableShortArraySource mainKeySource0;

    private ImmutableShortArraySource alternateKeySource0;

    public IncrementalAggOpenHasherWithTombstoneShort(ColumnSource[] tableKeySources,

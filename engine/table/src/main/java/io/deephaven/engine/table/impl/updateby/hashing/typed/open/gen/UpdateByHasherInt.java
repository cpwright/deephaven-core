...
final class UpdateByHasherInt extends UpdateByStateManagerTypedBase {
    private ImmutableIntArraySource mainKeySource0;

    private ImmutableIntArraySource alternateKeySource0;

    public UpdateByHasherInt(ColumnSource[] tableKeySources, ColumnSource[] originalTableKeySources,

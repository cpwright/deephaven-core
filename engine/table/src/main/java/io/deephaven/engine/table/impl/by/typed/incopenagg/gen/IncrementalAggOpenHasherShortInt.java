...
final class IncrementalAggOpenHasherShortInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherShortInt(ColumnSource[] tableKeySources,

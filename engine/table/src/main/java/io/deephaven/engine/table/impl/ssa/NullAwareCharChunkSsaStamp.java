...
// ****** Edit NullAwareCharChunkSsaStamp and run "./gradlew replicateSegmentedSortedArray" to regenerate
//
// @formatter:off
...
public class NullAwareCharChunkSsaStamp implements ChunkSsaStamp {
    ...
    public void processEntry(Chunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, SegmentedSortedArray ssa,
        ...
        processEntry(leftStampValues.asCharChunk(), leftStampKeys, (NullAwareCharSegmentedSortedArray) ssa, rightKeysForLeft,
                disallowExactMatch);
    }

    private static void processEntry(CharChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys,
            NullAwareCharSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {

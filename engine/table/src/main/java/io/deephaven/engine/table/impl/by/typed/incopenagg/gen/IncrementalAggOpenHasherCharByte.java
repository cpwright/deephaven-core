...
final class IncrementalAggOpenHasherCharByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherCharByte(ColumnSource[] tableKeySources,

...
final class StaticAggOpenHasherObjectLong extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableObjectArraySource mainKeySource0;

    private final ImmutableLongArraySource mainKeySource1;

    public StaticAggOpenHasherObjectLong(ColumnSource[] tableKeySources,

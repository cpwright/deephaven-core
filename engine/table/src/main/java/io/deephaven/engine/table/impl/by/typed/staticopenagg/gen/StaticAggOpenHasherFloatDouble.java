...
final class StaticAggOpenHasherFloatDouble extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableFloatArraySource mainKeySource0;

    private final ImmutableDoubleArraySource mainKeySource1;

    public StaticAggOpenHasherFloatDouble(ColumnSource[] tableKeySources,

...
final class IncrementalAggOpenHasherShortFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherShortFloat(ColumnSource[] tableKeySources,

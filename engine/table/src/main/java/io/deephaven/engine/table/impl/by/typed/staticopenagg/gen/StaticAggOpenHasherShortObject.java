...
final class StaticAggOpenHasherShortObject extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableShortArraySource mainKeySource0;

    private final ImmutableObjectArraySource mainKeySource1;

    public StaticAggOpenHasherShortObject(ColumnSource[] tableKeySources,

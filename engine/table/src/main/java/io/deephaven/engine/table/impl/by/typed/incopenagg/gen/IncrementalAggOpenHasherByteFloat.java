...
final class IncrementalAggOpenHasherByteFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherByteFloat(ColumnSource[] tableKeySources,

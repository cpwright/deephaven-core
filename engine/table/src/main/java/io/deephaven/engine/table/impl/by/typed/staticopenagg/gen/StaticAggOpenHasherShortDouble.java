...
final class StaticAggOpenHasherShortDouble extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableShortArraySource mainKeySource0;

    private final ImmutableDoubleArraySource mainKeySource1;

    public StaticAggOpenHasherShortDouble(ColumnSource[] tableKeySources,

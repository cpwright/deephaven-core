...
public class TestByteSparseArraySource extends AbstractByteColumnSourceTest {
    @NotNull
    @Override
    ByteSparseArraySource makeTestSource() {
    ...
    public void confirmAliasingForbidden() {
        ...
        final ByteSparseArraySource source = makeTestSource();
